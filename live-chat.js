...
function showReactionPicker(msgKey, anchorEl) {
  ...
  const chatRect = chatBox ? chatBox.getBoundingClientRect() : { left: 0, top: 0 };

  picker.style.position = "absolute";
  picker.style.left = Math.min(rect.left - chatRect.left, chatRect.width - 280) + "px";
  picker.style.top = (rect.top - chatRect.top - 48) + "px";
